...
for trial in range(1):
    ...
    for k in range(100):
        ...
        # previous_sol = np.array([mpc.data.prediction(('_x', 'x_com',0))[0][2], mpc.data.prediction(('_x', 'xd_com',0))[0][2],mpc.data.prediction(('_x', 'd_theta',0))[0][2], mpc.data.prediction(('_x', 'x_g',0))[0][2], mpc.data.prediction(('_x', 'y_g',0))[0][2]])
        t = time.time()
        u0 = mpc.make_step(x0)
